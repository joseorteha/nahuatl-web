...
export default function LoginPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-[#5DADE2]/20 via-white to-[#2ECC71]/10 py-8">
      <Image src="/logo.png" alt="Logo Code Master tik" width={80} height={80} className="mb-6 rounded-lg shadow-lg" />
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" passHref>
            <Image
              src="/logo.png" // Asegúrate de tener un logo en la carpeta /public
